...
=dyn_anisotropy_model.jl= - Methods for treating anisotropy (local landscape) dynamically
...
# TODOs
  ...
  6. Clean up dynamical kernels: categorize, consistent naming

  7. Enable LUT-defined methods

  8. Extend dynamical models
  ...
  10. [KILL] Admit differential equations for continuous time machines

  11. Redesign: implement consistently the notion of functions on the graph

  12. Redesign: incorporate linear terms
