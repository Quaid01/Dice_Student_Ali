...
mutable struct Model
    ...
    Ns::Float64
    # noise function
    # default = stream (generated by the code)
    # noise:Function
...
function trajectories(graph, duration, scale, method::Function, Ks, Vini, Ns)
...
function propagate_2(model::Model, tmax, Sstart, Xstart)
    ...
    Ns = model.Ns
    for tau in 1:(tmax - 1)
        DX = step_rate_2(graph, mtd, S, X, Ns).*scale
        update_2!(S, X, DX)
    end
    return (S, X)
end    
